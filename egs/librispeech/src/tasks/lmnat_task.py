...
class LMNATTask(BaseTask):
    #similar to cassnat task, but we also have a tokeniser and text encoder
    def __init__(self, mode, args):
        ...
        #based on type of text encoder, initilise encoder form lm, gpt or bert
    ...
    def load_pretrained_model(self, args):
        ...
        #if encoder is lm, we have to manually load params; else we just load bert or gpt model directly
        if args.init_text_encoder and args.text_encoder_path:
            ...
            if args.text_encoder_type == "lm":
                ...
                #///OG self.model.text_encoder.set_tied()
    ...
    def load_lm_model(self, args):
        #similar to impl in cassnat_task
    ...
    def run(self, args):
        #similar to cassnat, but also initialise params to help with greedy decoding
        best_epoch = 0
        best_wer = 100
