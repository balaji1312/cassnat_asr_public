...
def make_model(input_size, args):
    ...
    #Define model layers for conv encoding of input (conformer related); use_conv_enc is set in cassnat_train.yaml
    ...
    #else use default transformer model structure
    else:
